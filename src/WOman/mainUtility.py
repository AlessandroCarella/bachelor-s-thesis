...
from getPredictionsAndSaveThemOnFile import makeAndSavePredictionsOnFile, readPredictionsListFromFile
...
def main ():
    ...
    makeAndSavePredictionsOnFile (videosPathMain, getDetector())
    ...
    for singleVideoData in tqdm(data): #itero sui video
        videoExtractions = getSingleVideoExtraction(singleVideoData, labels [i], ACTION_UNITS_THRESHOLD)
        i += 1
