...
from classifiers.randomForestClassifier import getXtrainYTrain
from classifiers.KnnClassifier import getModelAccuracy
...
def getSVMClassifier():
    filePathSVMClassifier = join(dirname(abspath(__file__)), "classifiers/serializedObjects/SVMClassifier.pickle")
